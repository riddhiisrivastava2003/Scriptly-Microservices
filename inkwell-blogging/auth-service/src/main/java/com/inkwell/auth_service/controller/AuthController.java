...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> platformAnalytics() {
        ...
        Object postAnalytics = restTemplate.getForObject(postBaseUrl + "/api/admin/analytics", Object.class);
        Map commentCount = restTemplate.getForObject(commentBaseUrl + "/api/comments/count-total", Map.class);
        return ResponseEntity.ok(Map.of(
