...
public class PostService {
    ...
    public void deletePost(Long postId, Long actorUserId) {
        getPostById(postId);
        try {
            restTemplate.delete(commentBaseUrl + "/api/comments/post/" + postId);
    ...
    private void notifyNewsletter(Post post) {
        try {
            ...
            restTemplate.postForEntity(newsletterBaseUrl + "/internal/newsletter/new-post", payload, Void.class);
        } catch (Exception ignored) {
    ...
    private void notifyFollowers(Post post) {
        try {
            Map followersResponse = restTemplate.getForObject(
                    authBaseUrl + "/api/auth/internal/users/" + post.getAuthorId() + "/followers",
                    Map.class
            );
            ...
            restTemplate.postForEntity(notificationBaseUrl + "/api/notifications/internal/bulk", payload, Void.class);
        } catch (Exception ignored) {
    ...
    private void logAudit(Long actorUserId, String action, String entityType, Long entityId, String details) {
        try {
            ...
            restTemplate.postForEntity(authBaseUrl + "/api/auth/internal/audit-log", payload, Void.class);
        } catch (Exception ignored) {
